...
export default function Gallery() {
  ...
  const debounceHandleSearch = useCallback(
    debounce((nextValue) => handleNewSearchValue(nextValue), 800),
    []
  );
      ...
      <div className="container">
        ...
        <div className="content">
          ...
          <div className="gallery-grid">
            ...
            {(indexFetchStatus === FETCH_INDEX_PAGE_INFO_STATUS.SUCCEEDED ||
              indexFetchStatus === FETCH_INDEX_PAGE_INFO_STATUS.LOADING_MORE) &&
              searchStatus !== SEARCH_STATUS.Failed && <Cards events={items} />}
            {(indexFetchStatus === FETCH_INDEX_PAGE_INFO_STATUS.IDLE ||
              indexFetchStatus === FETCH_INDEX_PAGE_INFO_STATUS.LOADING) && (
              <Loader />
            )}
          </div>
